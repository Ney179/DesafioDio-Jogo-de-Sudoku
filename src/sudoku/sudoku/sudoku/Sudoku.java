...
public class Sudoku {
    ...
    public Sudoku() {
        ...
        initializeBoard(); // Inicializa o tabuleiro com alguns números aleatórios
    }

    // Método para inicializar o tabuleiro com alguns números aleatórios
    private void initializeBoard() {
        Random rand = new Random();
        for (int i = 0; i < SIZE; i++) {
            for (int j = 0; j < SIZE; j++) {
                // Preenche aleatoriamente algumas células com números de 1 a 9
                if (rand.nextInt(2) == 0) { // 50% de chance de preencher a célula
                    int num = rand.nextInt(9) + 1; // Número aleatório de 1 a 9
                    if (isSafe(i, j, num)) {
                        board[i][j] = num;
                    }
                }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Tabuleiro de Sudoku gerado (com alguns números aleatórios):");
        sudoku.printBoard();
        ...
        while (true) {
            ...
            if (sudoku.isSafe(row, col, num)) {
                ...
                if (sudoku.isBoardComplete()) {
                    ...
                    sudoku.printBoard(); // Exibe o tabuleiro final
